...
public:
    ...
    void update(sf::Vector2f pressure_force) {
        ...
        this->velocity.y = pressure_force.y * delta_t+this->velocity.y*0.89; // set to 0.92 when gravity on
        this->velocity.y += gravity * delta_t;
        this->velocity.x = pressure_force.x * delta_t + this->velocity.x * 0.89;
